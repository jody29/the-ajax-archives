...
const Page: NextPage<PageProps> = props => {
  ...
  const shareItems = [
    ...
    {
      url: `https://www.instagram.com/share?url=${encodeURIComponent(window.location.href)}&caption=${encodeURIComponent('Bekijk dit toffe item op The Ajax Archives!')}`,
      src: 'instagram.png'
    },
    {
      url: `https://twitter.com/intent/tweet?url=${encodeURIComponent(window.location.href)}&text=${encodeURIComponent('Bekijk dit toffe item op The Ajax Archives!')}`,
      src: 'twitter.png'
    },
    {
      url: '',
