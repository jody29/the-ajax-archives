...
const Page: NextPage<PageProps> = props => {
  ...
  const shareItems = [
    {
      url: `https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(asPath)}`,
      src: 'facebook.png'
    },
    {
      url: `https://www.instagram.com/share?url=${encodeURIComponent(asPath)}&caption=${encodeURIComponent('Bekijk dit toffe item op The Ajax Archives!')}`,
      src: 'instagram.png'
    },
    {
      url: `https://twitter.com/intent/tweet?url=${encodeURIComponent(asPath)}&text=${encodeURIComponent('Bekijk dit toffe item op The Ajax Archives!')}`,
      src: 'twitter.png'
    },
    {
      url: '',
