...
const Page: NextPage<PageProps> = props => {
  return (
    <>
      ...
      <Flex mt={22} justifyContent='space-between' gap={16}>
      <Image
      ...
      />
      <Box>
        <Heading color='red'>{props.collectorsItem.fields.naamItem}</Heading>
        <span style={{ fontWeight: 'bold' }}>{props.collectorsItem.fields.beschrijving}</span>
      </Box>
      </Flex>
    </>
  );
