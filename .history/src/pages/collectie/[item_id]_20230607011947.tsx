...
const Page: NextPage<PageProps> = props => {
  ...
  return (
    <>
      ...
      <Modal {...modalDisclosure} size='full'>
        <ModalOverlay />
        <ModalContent w='100%'>
          <Image src={props.collectorsItem.fields.afbeelding.fields.file.url} alt={props.collectorsItem.fields.afbeelding.fields.title} w='100%' />
        </ModalContent>
      </Modal>
      <Box mb={24}>
