        ...
        <Flex flexDir='column' w='50%'>
          ...
          <Box mt={6}>
            ...
            <Flex gap={2}>
              ...
              {copied && (
                <Flex position='fixed' gap={2} boxShadow='0 0 5px black' alignItems='center' p={4} color='white' borderRadius='10px' bottom={10} left='50%' bg='gray' transform='translateX(-50%)'>
                  <Text>Gekopieërd naar klembord!</Text>
                  <Icon fontSize='1.5rem' bg='white' p={2} borderRadius='full' color='green'>
                    <Check />
                  </Icon>
                </Flex>
              )}
