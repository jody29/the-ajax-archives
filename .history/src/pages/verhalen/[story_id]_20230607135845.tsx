...
const options = {
    ...
    renderNode: {
        ...
        [BLOCKS.QUOTE]: (node: Node, children: ReactNode) => <Prose><blockquote style={{ padding: '15px 20px', borderLeft: '3px solid gray', fontSize: '1.2rem' }}>{children}</blockquote></Prose>,
