...
const options = {
    ...
    renderNode: {
        ...
        [BLOCKS.QUOTE]: (node: Node, children: ReactNode) => <blockquote style={{ padding: '0', width: '50%', borderLeft: '3px solid #6c6c6c', marginBottom: '40px', fontWeight: 'bold', color: '#6c6c6c' }}>{children}</blockquote>,
