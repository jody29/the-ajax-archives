...
const options = {
    ...
    renderNode: {
        ...
        [BLOCKS.QUOTE]: (node: Node, children: ReactNode) => <blockquote style={{ padding: '15px 20px', borderLeft: '3px solid gray', marginBottom: '40px', fontWeight: 'bold' }}>{children}</blockquote>,
