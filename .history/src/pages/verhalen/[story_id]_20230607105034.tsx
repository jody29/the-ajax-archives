...
const Page: NextPage<PageProps> = props => {
  ...
  return (
    <>
      ...
      <Image src={props.story.fields?.thumbnail?.fields.file.url as string} alt={props.story.fields.thumbnail?.fields.title} mt={6} mb={12} h={600} w='full' objectFit='cover' />
      <Footer />
    </>
  );
};
