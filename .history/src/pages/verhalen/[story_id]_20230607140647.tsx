...
const options = {
    ...
    renderNode: {
        ...
        [BLOCKS.QUOTE]: (node: Node, children: ReactNode) => <blockquote style={{ padding: '10px 20px 0px', borderLeft: '3px solid #6c6c6c', marginBottom: '40px', fontWeight: 'bold', color: '#6c6c6c' }}>{children}</blockquote>,
