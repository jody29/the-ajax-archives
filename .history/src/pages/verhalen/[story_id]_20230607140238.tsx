...
const options = {
    ...
    renderNode: {
        ...
        [BLOCKS.QUOTE]: (node: Node, children: ReactNode) => <blockquote style={{ padding: '15px 20px', borderLeft: '3px solid #6c6c6c', lineHeight: '0', marginBottom: '40px', fontWeight: 'bold', color: '#6c6c6c' }}>{children}</blockquote>,
