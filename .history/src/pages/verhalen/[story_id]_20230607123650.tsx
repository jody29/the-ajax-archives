...
const options = {
    ...
    renderNode: {
        [BLOCKS.PARAGRAPH]: (node: Node, children: ReactNode) => <Text>{children}</Text>,
        [BLOCKS.HEADING_2]: (node: Node, children: ReactNode) => <Heading fontWeight='bold' mb={4} fontSize='2.3rem'>{children}</Heading>,
