  ...
  useEffect(() => {
    const fetchData = async () => {
      if (inputValue.length > 0) {
        const collectie = await axios.get(`https://cdn.contentful.com/spaces/m8mhss8s8opk/environments/master/entries`, {
          params: {
            access_token: 'podsPbEkhpWivmStiW4H5QTc0W8jNb-dz1IgqvYSJMI',
            content_type: 'collectie'
          }
        })
        const verhalen = await axios.get(`https://cdn.contentful.com/spaces/m8mhss8s8opk/environments/master/entries`, {
          params: {
            acces_token: 'podsPbEkhpWivmStiW4H5QTc0W8jNb-dz1IgqvYSJMI',
