...
export function ImageMarker(props: ImageMarkerProps) {
  ...
  return (
    <Link href={`/verhalen/${props.link}`} passHref>
      <Flex as="a" alignItems='center' flexDir='column' onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
        ...
        <Image src={props?.image?.fields.file.url} borderRadius='50%' w={14} h={14} objectFit='cover' mb={isHovered ? 3 : 1} transform={isHovered ? 'scale(1.2)' : 'scale(1)'} transition='transform 0.4s ease-in-out, margin 0.4s ease-in-out' />
