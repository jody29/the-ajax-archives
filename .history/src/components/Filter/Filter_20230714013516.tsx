...
export const Filter = (props: FilterProps) => {
  ...
  return (
    <form id="filterForm" noValidate>
      <Flex bg='white' position='absolute' zIndex={1} p='2rem' w='25rem' right={0} top={0} bottom={0} boxShadow='0 0 10px rgba(0,0,0,.5)' flexDir='column'>
        ...
        <Stack pb={6} mt={0} borderBottom='1px solid gray'>
