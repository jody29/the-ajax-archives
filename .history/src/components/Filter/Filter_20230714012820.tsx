    ...
    <form id="filterForm" noValidate>
      <Box bg='white' position='absolute' zIndex={1} p='2rem' w='25rem' right={0} top={0} bottom={0} boxShadow='0 0 10px rgba(0,0,0,.5)'>
        <Flex alignItems='center' pb={8} mb={6} borderBottom='1px solid gray'>
          <Heading fontSize='1.4rem'>Filter</Heading>
          <IconButton aria-label="close filter" size='xs' bg='transparent' color='slatergray' fontSize='1rem' icon={ <CloseNormalIcon /> } ml='auto' />
        </Flex>
        <Flex position='relative' flexDir='column' >
          <Stack>
            <Heading fontSize='1.4rem' mb={1}>Filter op type item</Heading>
          ...
          <Stack mt={4}>
            <Heading fontSize='1.4rem' mb={1}>Filter op competitie</Heading>
            <Flex flexDir='column' gap={2}>
          ...
          <Stack mt={4} >
            <Heading fontSize='1.4rem' mb={1}>Filter op periode</Heading>
            <Box>
