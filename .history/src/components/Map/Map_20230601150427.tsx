  ...
  return (
    <Box w='100%' overflow='hidden'>
      ...
      <Flex justifyContent='center' gap={2} my={4}>
        <Button variant='secondary' color='black' fontSize='1.4rem'>Nederland</Button>
        <Button variant='secondary' color='black' fontSize='1.4rem' fontWeight='bold' borderBottom='2px solid black'>Europa</Button>
      </Flex>
    </Box>
  );
}
