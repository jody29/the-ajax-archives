...
export const Filter = (props: FilterProps) => {
  ...
  return (
    <Box bg='white' position='absolute' zIndex={2} p='2rem' w='23rem' right={0} top='4rem' borderRadius='15px' boxShadow='0 0 10px rgba(0,0,0,.5)'>
      <Stack>
      ...
      <Button w='full' borderRadius='base' mt={6}>Toon items</Button>
    </Box>
  );
}
